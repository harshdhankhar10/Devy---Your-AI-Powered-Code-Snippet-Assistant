    ...
    const handlePurchase = async (packId: string, amount: number) => {
        ...
        try {
            ...
            const options = {
                ...
                name: 'Devy',
                description: `Purchase of credits - ${orderData.package.name}`,
                ...
                handler: async function (razorpayResponse: any) {
                    try {
                        ...
                        Swal.fire({
                            ...
                            text: `Payment successful! ${verificationData.credits} credits added to your account.`,
                            icon: "success",
                        });
                    ...
                    return (
                        <Card key={pack.id} className={`relative ${pack.popular ? 'ring-2 ring-blue-500 shadow-lg' : ''} ${pack.bestValue ? 'ring-2 ring-green-500 shadow-lg' : ''}`}>
                            ...
                            <CardContent className="space-y-6">
                                ...
                                >
                                    {isProcessing === pack.id ? 'Processing...' : `Buy ${pack.name}`}
